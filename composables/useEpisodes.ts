...
export interface Episode {
  ...
  status: string
  tags: string | null
  /** Internal scratch space. Never enters the RSS feed. */
...
/**
 * A pull quote hanging off an episode. Not feed content — this is material
 * for downstream surfaces, authored by hand or generated by the
