      ...
      <template v-if="podcastSlug">
        ...
        <li class="more-wrap" ref="moreRef" :class="{ 'more-open': moreOpen, 'more-active': isInMoreSection }">
          ...
          <ul class="more-panel">
            ...
            <li><NuxtLink :to="`/podcasts/${podcastSlug}/corrections`" active-class="active">Corrections</NuxtLink></li>
...
const MORE_SEGMENTS = ['preview', 'storage', 'distribution', 'corrections', 'build', 'import-rss', 'members', 'audit']
